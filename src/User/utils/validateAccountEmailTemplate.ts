                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                          ...
                          <tr>
                            <td role="modules-container"
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                role="module" data-type="columns" style="padding:30px 0px 30px 30px;" bgcolor="#42cef5"
                                data-distribution="1">
                                <tbody>
                                  <tr role="module-content">
                                    <td height="100%" valign="top">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td
                                                      ...
                                                      valign="top" align="center">
                                                      <img class="max-width" border="0"
                                                        style="display:block; color:#f5d442; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;"
                                                        width="300" alt="" data-proportionally-constrained="true"
                                                        data-responsive="false"
                                                        src="https://i.postimg.cc/j5LyFtVT/images-Photo-Room-Reco.png"
                                                        height="200">
                                                    </td>
                                                  </tr>
                                                </tbody>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                role="module" data-type="columns" style="padding:50px 0px 0px 30px;" bgcolor="#f9f7f5"
                                data-distribution="1">
                                <tbody>
                                  <tr role="module-content">
                                    <td height="100%" valign="top">
                                                  ...
                                                  <tr>
                                                    <td
                                                      ...
                                                      <img class="max-width" border="0"
                                                        ...
                                                        width="362" alt="" data-proportionally-constrained="true"
                                                        data-responsive="false"
                                                        src="https://i.postimg.cc/SRvSwZhy/Welcome-No-Background.png"
                                                        height="100">
                                                    </td>
                                                  </tr>
                                                </tbody>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td align="center" bgcolor="#fbca5b" class="inner-td"
                                                              ...
                                                              <a href=${link}
                                                                style="background-color:#fb9818; border:1px solid #fbca5b; border-color:#fbca5b; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 50px 12px 50px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                  ...
                                                  <tr>
                                                    <td
                                                      ...
                                                      <div>
                                                        ...
                                                        <div style="font-family: inherit; text-align: inherit"><span
                                                            style="color: #00634a">Call Us at +51 969870875</span></div>
                                                        <div style="font-family: inherit; text-align: inherit"><span
                                                            style="color: #00634a">or Email at
                                                            toy@gmail.com</span></div>
                                                        <div></div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                  ...
                                  <tr>
                                    <td style="padding:0px 0px 0px 0px;" role="module-content" height="100%"
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="padding:0px 0px 7px 0px;" bgcolor="#f54299"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </td>
                                ...
                                <tbody>
                                  <tr>
                                    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top"
                                      ...
                                      <img class="max-width" border="0"
                                        style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;"
                                        width="605"  alt="" data-proportionally-constrained="true" data-responsive="true"
                                        src="https://i.postimg.cc/Sxq1khfj/azul.png">
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
